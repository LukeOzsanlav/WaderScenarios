...
### Norfolk Broads Results

For the Norfolk Broads we had two different stakeholder groups. Group 1 (G1) was a group of conservationists and group 2 was a group of various public body representatives tasked with wider objectives than the preservation of biodiversity (e.g. Natural England, Internal drainage board, Broads Authority and Norfolk FWAG). The stakeholder guidelines that were generated during the workshops and how these were converted into a graded map can be found in @tbl-NorG1 for group 1 and @tbl-NorG2 for group 2. The fields identified as grassland or arable land that have the right characteristics to be lowland wet grassland, regardless of their current condition, can be seen in @fig-BroadsSuitHab and existing wader sites can be seen in @fig-BroadsLawton.

![Parcels in the Norfolk Broads that were identified as having the right soil types and elevation to become lowland wet grassland, regardless of current condition. An OS map is used as the background.](Plots/Broads_OpportunityHabitatMap.png){#fig-BroadsSuitHab fig.pos="h" fig-align="center" width="900"}

![Parcels in the Norfolk Broads that were identified as being part of lowland breeding wader clusters. These clusters were identified using the breeding waders of wet meadows survey data from 2021-23.](Plots/Broads_LawtonPrincipleMap.png){#fig-BroadsLawton fig.pos="h" fig-align="center" height="900"}

#### Norfolk Broads: Better

The stakeholder preferences for the better principle of nature restoration for group 1 and group 2 can be visualized in (@fig-BroadsBetterG1) and (@fig-BroadsBetterG2), receptively.

![Stakeholder gradings for group 1 in the Norfolk Broads for the better principle of nature restoration](Plots/Broads_G1_Better.png){#fig-BroadsBetterG1 fig.pos="h" height="1050"}

![Stakeholder gradings for group 2 in the Norfolk Broads for the better principle of nature restoration](Plots/Broads_G2_Better.png){#fig-BroadsBetterG2 fig.pos="h" height="1000"}

{{< pagebreak >}}

#### Norfolk Broads: Bigger

The stakeholder preferences for the bigger principle of nature restoration for group 1 (@fig-BroadsBigG1) and 2 (@fig-BroadsBigG2).

![Stakeholder gradings for group 1 in the Norfolk Broads for the bigger principle of nature restoration](Plots/Broads_G1_Bigger.png){#fig-BroadsBigG1 fig.pos="h" height="950"}

![Stakeholder gradings for group 2 in the Norfolk Broads for the bigger principle of nature restoration](Plots/Broads_G2_Bigger.png){#fig-BroadsBigG2 fig.pos="h" height="900"}

{{< pagebreak >}}

#### Norfolk Broads: More

The stakeholder preferences for the more principle of nature restoration for group 1 (@fig-BroadsMoreG1) and 2 (@fig-BroadsMoreG2).

![Stakeholder gradings for group 1 in the Norfolk Broads for the more principle of nature restoration](Plots/Broads_G1_More.png){#fig-BroadsMoreG1 fig.pos="h" height="900"}

![Stakeholder gradings for group 2 in the Norfolk Broads for the more principle of nature restoration](Plots/Broads_G2_More.png){#fig-BroadsMoreG2 fig.pos="h" height="900"}

{{< pagebreak >}}

#### Norfolk Broads: Arable Conversion for Bigger

The stakeholder preferences for the conversion of arable land to lowland wet grassland under the bigger principle of nature restoration for group 1 (@fig-BroadsArBigG1) and 2 (@fig-BroadsArBigG2).

![Stakeholder gradings for group 1 in the Norfolk Broads for the reversion of arable land to lowland wet grassland under the bigger principle of nature restoration](Plots/Broads_G1_ArableBig.png){#fig-BroadsArBigG1 fig.pos="h" height="900"}

![Stakeholder gradings for group 2 in the Norfolk Broads for the reversion of arable land to lowland wet grassland under the bigger principle of nature restoration](Plots/Broads_G2_ArableBig.png){#fig-BroadsArBigG2 fig.pos="h" height="900"}

{{< pagebreak >}}

#### Norfolk Broads: Arable Conversion for More

The stakeholder preferences for the conversion of arable land to lowland wet grassland under the more principle of nature restoration for group 1 (@fig-BroadsArMoreG1) and 2 (@fig-BroadsArMoreG2).

![Stakeholder gradings for group 1 in the Norfolk Broads for the reversion of arable land to lowland wet grassland under the more principle of nature restoration](Plots/Broads_G1_ArableMore.png){#fig-BroadsArMoreG1 fig.pos="h" height="900"}

![Stakeholder gradings for group 2 in the Norfolk Broads for the reversion of arable land to lowland wet grassland under the more principle of nature restoration](Plots/Broads_G2_ArableMore.png){#fig-BroadsArMoreG2 fig.pos="h" height="900"}
...
The stakeholder preferences for the better principle of nature restoration for group 1 and group 2 can be visualized in (@fig-NKBetterG1) and (@fig-NKBetterG2), receptively. The stakeholder guidelines that were used to produce these maps can be found in @tbl-KeG1 for group 1 and @tbl-KeG2 for group 2.
...
For Essex we had two different stakeholder groups. Group 1 was a group of conservationists and group 2 was a group of landowners and farmers. The stakeholder guidelines that were generated during the workshops and how these were converted into a graded map can be found in @tbl-EsG1 for group 1 and @tbl-EsG2 for group 2. The fields identified as grassland or arable land that have the right characteristics to be lowland wet grassland, regardless of their current condition, can be seen in @fig-EssexSuitHab and existing wader sites can be seen in @fig-EssexLawton.

![Parcels in Essext that were identified as having the right soil type and elevation to become lowland wet grassland, regardless of current condition. An OS map is used as the background.](Plots/Essex_OpportunityHabitatMap.png){#fig-EssexSuitHab fig.pos="h" fig-align="center" width="700"}

![Parcels in Essex that we identified as being part of lowland breeding wader clusters. These clusters were identified using the breeding waders of wet meadows survey data from 2021-23.](Plots/Essex_LawtonPrincipleMap.png){#fig-EssexLawton fig.pos="h" fig-align="center" width="700"}

#### Essex: Better

The stakeholder preferences for the better principle of nature restoration for group 1 and group 2 can be visualized in (@fig-EsBetterG1) and (@fig-EsBetterG2), receptively. The stakeholder guidelines that were used to produce these maps can be found in @tbl-EsG1 for group 1 and @tbl-EsG2 for group 2.

![Stakeholder gradings for group 1 in Essex for the better principle of nature restoration](Plots/Essex_G1_Better.png){#fig-EsBetterG1 fig.pos="h" width="700"}

![Stakeholder gradings for group 2 in Essex for the better principle of nature restoration](Plots/Essex_G2_Better.png){#fig-EsBetterG2 fig.pos="h" width="700"}

{{< pagebreak >}}

#### Essex: Bigger

The stakeholder preferences for the bigger principle of nature restoration for group 1 (@fig-EsBigG1) and 2 (@fig-EsBigG2).

![Stakeholder gradings for group 1 in Essex for the bigger principle of nature restoration](Plots/Essex_G1_Bigger.png){#fig-EsBigG1 fig.pos="h" width="700"}

![Stakeholder gradings for group 2 in Essex for the bigger principle of nature restoration](Plots/Essex_G2_Bigger.png){#fig-EsBigG2 fig.pos="h" width="700"}

{{< pagebreak >}}

#### Essex: More

The stakeholder preferences for the more principle of nature restoration for group 1 (@fig-EsMoreG1) and 2 (@fig-EsMoreG2).

![Stakeholder gradings for group 1 in Essex for the more principle of nature restoration](Plots/Essex_G1_More.png){#fig-EsMoreG1 fig.pos="h" width="700"}

![Stakeholder gradings for group 2 in Essex for the more principle of nature restoration](Plots/Essex_G2_More.png){#fig-EsMoreG2 fig.pos="h" width="700"}

{{< pagebreak >}}

#### Essex: Arable Conversion for Bigger

The stakeholder preferences for the conversion of arable land to lowland wet grassland under the bigger principle of nature restoration for group 1 (@fig-EsArBigG1) and 2 (@fig-EsArBigG2).

![Stakeholder gradings for group 1 in Essex for the reversion of arable land to lowland wet grassland under the bigger principle of nature restoration](Plots/Essex_G1_ArableBig.png){#fig-EsArBigG1 fig.pos="h" width="700"}

![Stakeholder gradings for group 2 in Essex for the reversion of arable land to lowland wet grassland under the bigger principle of nature restoration](Plots/Essex_G2_ArableBig.png){#fig-EsArBigG2 fig.pos="h" width="700"}

{{< pagebreak >}}

#### Essex: Arable Conversion for More

The stakeholder preferences for the conversion of arable land to lowland wet grassland under the more principle of nature restoration for group 1 (@fig-EsArMoreG1) and 2 (@fig-EsArMoreG2).

![Stakeholder gradings for group 1 in Essex for the reversion of arable land to lowland wet grassland under the more principle of nature restoration](Plots/Essex_G1_ArableMore.png){#fig-EsArMoreG1 fig.pos="h" width="700"}

![Stakeholder gradings for group 2 in Essex for the reversion of arable land to lowland wet grassland under the more principle of nature restoration](Plots/Essex_G2_ArableMore.png){#fig-EsArMoreG2 fig.pos="h" width="700"}

{{< pagebreak >}}

### Somerset Levels Results

For the Somerset Levels we had three different stakeholder groups. Group 1 (G1) was a group of conservationists, group 2 was a group of various body representatives tasked with wider objectives than the preservation of biodiversity (e.g. Natural England, Internal drainage board, Environment Agency and South West FWAG) group 3 was a group of landowners and farmers. The stakeholder guidelines that were generated during the workshops and how these were converted into a graded map can be found in@tbl-SomG1 for group 1, @tbl-SomG2 for group 2 and @tbl-SomG3 for group 3. The fields identified as grassland or arable land that have the right characteristics to be lowland wet grassland, regardless of their current condition, can be seen in @fig-SomSuitHab and existing wader sites can be seen in @fig-SomLawton.

![Parcels in the Somerset Levels that were identified as having the right soil type and elevation to become lowland wet grassland, regardless of current condition. An OS map is used as the background.](Plots/Somerset_OpportunityHabitatMap.png){#fig-SomSuitHab fig.pos="h" fig-align="center" width="900"}

![Parcels in the Somerset Levels that were identified as being part of lowland breeding wader clusters. These clusters were identified using the breeding waders of wet meadows survey data from 2021-23.](Plots/Somerset_LawtonPrincipleMap.png){#fig-SomLawton fig.pos="h" fig-align="center" height="900"}

#### Somerset Levels: Better

The stakeholder preferences for the better principle of nature restoration for group 1, group 2 and group 3 can be visualized in (@fig-SomBetterG1), (@fig-SomBetterG2) and (@fig-SomBetterG3) receptively. The stakeholder guidelines that were used to produce these maps can be found in @tbl-SomG1 for group 1, @tbl-SomG2 for group 2 and @tbl-SomG3 for group 3.

![Stakeholder gradings for group 1 in the Somerset Levels for the better principle of nature restoration](Plots/Somerset_G1_Better.png){#fig-SomBetterG1 fig.pos="h" height="900"}

![Stakeholder gradings for group 2 in the Somerset Levels for the better principle of nature restoration](Plots/Somerset_G2_Better.png){#fig-SomBetterG2 fig.pos="h" height="900"}

![Stakeholder gradings for group 3 in the Somerset Levels for the better principle of nature restoration](Plots/Somerset_G3_Better.png){#fig-SomBetterG3 fig.pos="h" height="900"}

{{< pagebreak >}}

#### Somerset Levels: Bigger

The stakeholder preferences for the bigger principle of nature restoration for group 1 (@fig-SomBigG1), group 2 (@fig-SomBigG2) and group 3 (@fig-SomBigG3).

![Stakeholder gradings for group 1 in the Somerset Levels for the bigger principle of nature restoration](Plots/Somerset_G1_Bigger.png){#fig-SomBigG1 fig.pos="h" height="900"}

![Stakeholder gradings for group 2 in the Somerset Levels for the bigger principle of nature restoration](Plots/Somerset_G2_Bigger.png){#fig-SomBigG2 fig.pos="h" height="900"}

![Stakeholder gradings for group 3 in the Somerset Levels for the bigger principle of nature restoration](Plots/Somerset_G3_Bigger.png){#fig-SomBigG3 fig.pos="h" height="900"}

{{< pagebreak >}}

#### Somerset Levels: More

The stakeholder preferences for the more principle of nature restoration for group 1 (@fig-SomMoreG1), group 2 (@fig-SomMoreG2) and group 3 (@fig-SomMoreG3).

![Stakeholder gradings for group 1 in the Somerset Levels for the more principle of nature restoration](Plots/Somerset_G1_More.png){#fig-SomMoreG1 fig.pos="h" height="900"}

![Stakeholder gradings for group 2 in the Somerset Levels for the more principle of nature restoration](Plots/Somerset_G2_More.png){#fig-SomMoreG2 fig.pos="h" height="900"}

![Stakeholder gradings for group 3 in the Somerset Levels for the more principle of nature restoration](Plots/Somerset_G3_More.png){#fig-SomMoreG3 fig.pos="h" height="900"}

{{< pagebreak >}}

#### Somerset Levels: Arable Reversion for Bigger

The stakeholder preferences for the reversion of arable land to lowland wet grassland under the bigger principle of nature restoration for group 1 (@fig-SomArBigG1), group 2 (@fig-SomArBigG2) and group 3 (@fig-SomArBigG3).

![Stakeholder gradings for group 1 in the Somerset Levels for the reversion of arable land to lowland wet grassland under the bigger principle of nature restoration](Plots/Somerset_G1_ArableBig.png){#fig-SomArBigG1 fig.pos="h" height="900"}

![Stakeholder gradings for group 2 in the Somerset Levels for the reversion of arable land to lowland wet grassland under the bigger principle of nature restoration](Plots/Somerset_G2_ArableBig.png){#fig-SomArBigG2 fig.pos="h" height="900"}

![Stakeholder gradings for group 3 in the Somerset Levels for the the reversion of arable land to lowland wet grassland under bigger principle of nature restoration](Plots/Somerset_G3_ArableBig.png){#fig-SomArBigG3 fig.pos="h" height="900"}

{{< pagebreak >}}

#### Somerset Levels: Arable Reversion for More

The stakeholder preferences for the reversion of arable land to lowland wet grassland under the more principle of nature restoration for group 1 (@fig-SomArMoreG1), group 2 (@fig-SomArMoreG2) and group 3 (@fig-SomArMoreG3).

![Stakeholder gradings for group 1 in the Somerset Levels for the reversion of arable land to lowland wet grassland under the bigger principle of nature restoration](Plots/Somerset_G1_ArableMore.png){#fig-SomArMoreG1 fig.pos="h" height="900"}

![Stakeholder gradings for group 2 in the Somerset Levels for the reversion of arable land to lowland wet grassland under the bigger principle of nature restoration](Plots/Somerset_G2_ArableMore.png){#fig-SomArMoreG2 fig.pos="h" height="900"}

![Stakeholder gradings for group 3 in the Somerset Levels for the the reversion of arable land to lowland wet grassland under bigger principle of nature restoration](Plots/Somerset_G3_ArableMore.png){#fig-SomArMoreG3 fig.pos="h" height="900"}
...
```{R, echo=F, warning = F, output = T}
#| label: tbl-NorG2
#| tbl-cap: "Stakeholder rules generated during a workshop for the Broads group 2 (public bodies). See @tbl-Citations for full citation of each reference"

kbl(NorG2, longtable = T) %>% 
  kable_styling(latex_options = c("repeat_header", "striped"), font_size = 7, full_width = F) |> 
  row_spec(0, font_size = 8, bold = T) |> 
  column_spec(1, width = "5em") |> 
  column_spec(2, width = "10em") |>
...
```{R, echo=F, warning = F, output = T}
#| label: tbl-EsG1
#| tbl-cap: "Stakeholder rules generated during a workshop for Essex group 1 (conservationists). See @tbl-Citations for full citation of each reference"

## Essex Tables
kbl(EsG1, longtable = T) %>% 
  kable_styling(latex_options = c("repeat_header", "striped"), font_size = 7, full_width = F) |> 
  row_spec(0, font_size = 8, bold = T) |> 
  column_spec(1, width = "5em") |> 
  column_spec(2, width = "10em") |>
...
```{R, echo=F, warning = F, output = T}
#| label: tbl-EsG2
#| tbl-cap: "Stakeholder rules generated during a workshop for Essex group 2 (landowners and famers). See @tbl-Citations for full citation of each reference"

kbl(EsG2, longtable = T) %>% 
  kable_styling(latex_options = c("repeat_header", "striped"), font_size = 7, full_width = F) |> 
  row_spec(0, font_size = 8, bold = T) |> 
  column_spec(1, width = "5em") |> 
  column_spec(2, width = "10em") |>
...
```{R, echo=F, warning = F, output = T}
#| label: tbl-SomG1
#| tbl-cap: "Stakeholder rules generated during a workshop for Somerset Levels group 1 (conservationists). See @tbl-Citations for full citation of each reference"

## Somerset Levels Tables
kbl(SomG1, longtable = T) %>% 
  kable_styling(latex_options = c("repeat_header", "striped"), font_size = 7, full_width = F) |> 
  row_spec(0, font_size = 8, bold = T) |> 
  column_spec(1, width = "5em") |> 
  column_spec(2, width = "10em") |>
...
```{R, echo=F, warning = F, output = T}
#| label: tbl-SomG2
#| tbl-cap: "Stakeholder rules generated during a workshop for Somerset Levels group 2 (public bodies). See @tbl-Citations for full citation of each reference"

kbl(SomG2, longtable = T) %>% 
  kable_styling(latex_options = c("repeat_header", "striped"), font_size = 7, full_width = F) |> 
  row_spec(0, font_size = 8, bold = T) |> 
  column_spec(1, width = "5em") |> 
  column_spec(2, width = "10em") |>
...
```{R, echo=F, warning = F, output = T}
#| label: tbl-SomG3
#| tbl-cap: "Stakeholder rules generated during a workshop for Somerset Levels group 3 (landowners and famers). See @tbl-Citations for full citation of each reference"

kbl(SomG3, longtable = T) %>% 
  kable_styling(latex_options = c("repeat_header", "striped"), font_size = 7, full_width = F) |> 
  row_spec(0, font_size = 8, bold = T) |> 
  column_spec(1, width = "5em") |> 
  column_spec(2, width = "10em") |>
