  ...
  pdf: 
    ...
    include-in-header: 
      text: |
        ...
        \lofoot{Report to Natural England}
    header-includes: 
...
**Data Availability:** To download any of the maps as png files or the spatial files used to create the maps (tif files) then please visit [here](https://github.com/LukeOzsanlav/WaderScenarios/tree/main/CleanData/Guideline%20Creation). To access the code used to create each guideline please visit [here](https://github.com/LukeOzsanlav/WaderScenarios/tree/main/Code/Guideline%20Creation).
...
![Parcels in the Norfolk Broads that were identified as having the right soil types and elevation to become lowland wet grassland, regardless of current condition. An OS map is used as the background.](Plots/Broads_OpportunityHabitatMap.png){#fig-BroadsSuitHab fig.pos="h" fig-align="center" width="650"}

![Parcels in the Norfolk Broads that were identified as being part of lowland breeding wader clusters. These clusters were identified using the breeding waders of wet meadows survey data from 2021-23.](Plots/Broads_LawtonPrincipleMap.png){#fig-BroadsLawton fig.pos="h" fig-align="center" width="650"}
...
![Stakeholder gradings for group 1 in the Norfolk Broads for the better principle of nature restoration](Plots/Broads_G1_Better.png){#fig-BroadsBetterG1 fig.pos="h" width="650"}

![Stakeholder gradings for group 2 in the Norfolk Broads for the better principle of nature restoration](Plots/Broads_G2_Better.png){#fig-BroadsBetterG2 fig.pos="h" width="650"}
...
![Stakeholder gradings for group 1 in the Norfolk Broads for the bigger principle of nature restoration](Plots/Broads_G1_Bigger.png){#fig-BroadsBigG1 fig.pos="h" width="650"}

![Stakeholder gradings for group 2 in the Norfolk Broads for the bigger principle of nature restoration](Plots/Broads_G2_Bigger.png){#fig-BroadsBigG2 fig.pos="h" width="650"}
...
![Stakeholder gradings for group 1 in the Norfolk Broads for the more principle of nature restoration](Plots/Broads_G1_More.png){#fig-BroadsMoreG1 fig.pos="h" width="650"}

![Stakeholder gradings for group 2 in the Norfolk Broads for the more principle of nature restoration](Plots/Broads_G2_More.png){#fig-BroadsMoreG2 fig.pos="h" width="650"}

{{< pagebreak >}}

### Norfolk Broads: Arable Conversion for Bigger

Stakeholder preferences for reversion of arable land to lowland wet grassland under the bigger principle of nature restoration for group 1 (@fig-BroadsArBigG1) and 2 (@fig-BroadsArBigG2).

![Norfolk Broads stakeholder group 1 gradings for the reversion of arable land to lowland wet grassland under the bigger principle of nature restoration](Plots/Broads_G1_ArableBig.png){#fig-BroadsArBigG1 fig.pos="h" width="640"}

![Norfolk Broads stakeholder group 2 gradings for the reversion of arable land to lowland wet grassland under the bigger principle of nature restoration](Plots/Broads_G2_ArableBig.png){#fig-BroadsArBigG2 fig.pos="h" width="650"}

{{< pagebreak >}}

### Norfolk Broads: Arable Conversion for More

Stakeholder preferences for reversion of arable land to lowland wet grassland under the more principle of nature restoration for group 1 (@fig-BroadsArMoreG1) and 2 (@fig-BroadsArMoreG2).

![Norfolk Broads stakeholder group 1 gradings for the reversion of arable land to lowland wet grassland under the more principle of nature restoration](Plots/Broads_G1_ArableMore.png){#fig-BroadsArMoreG1 fig.pos="h" width="640"}

![Norfolk Broads stakeholder group 2 gradings for the reversion of arable land to lowland wet grassland under the more principle of nature restoration](Plots/Broads_G2_ArableMore.png){#fig-BroadsArMoreG2 fig.pos="h" width="650"}
...
The stakeholder preferences for the better principle of nature restoration for group 1 and group 2 can be visualized in (@fig-EsBetterG1) and (@fig-EsBetterG2), receptively.
...
Stakeholder preferences for reversion of arable land to lowland wet grassland under the bigger principle of nature restoration for group 1 (@fig-EsArBigG1) and 2 (@fig-EsArBigG2).
...
Stakeholder preferences for reversion of arable land to lowland wet grassland under the more principle of nature restoration for group 1 (@fig-EsArMoreG1) and 2 (@fig-EsArMoreG2).
...
![Parcels in the Somerset Levels that were identified as having the right soil type and elevation to become lowland wet grassland, regardless of current condition. An OS map is used as the background.](Plots/Somerset_OpportunityHabitatMap.png){#fig-SomSuitHab fig.pos="h" fig-align="center" width="650"}

![Parcels in the Somerset Levels that were identified as being part of lowland breeding wader clusters. These clusters were identified using the breeding waders of wet meadows survey data from 2021-23.](Plots/Somerset_LawtonPrincipleMap.png){#fig-SomLawton fig.pos="h" fig-align="center" width="650"}

{{< pagebreak >}}

### Somerset Levels: Better

The stakeholder preferences for the better principle of nature restoration for group 1, group 2 and group 3 can be visualized in (@fig-SomBetterG1), (@fig-SomBetterG2) and (@fig-SomBetterG3) receptively.

![Stakeholder gradings for group 1 in the Somerset Levels for the better principle of nature restoration](Plots/Somerset_G1_Better.png){#fig-SomBetterG1 fig.pos="h" width="650"}

![Stakeholder gradings for group 2 in the Somerset Levels for the better principle of nature restoration](Plots/Somerset_G2_Better.png){#fig-SomBetterG2 fig.pos="h" width="650"}

![Stakeholder gradings for group 3 in the Somerset Levels for the better principle of nature restoration](Plots/Somerset_G3_Better.png){#fig-SomBetterG3 fig.pos="h" width="650"}
...
![Stakeholder gradings for group 1 in the Somerset Levels for the bigger principle of nature restoration](Plots/Somerset_G1_Bigger.png){#fig-SomBigG1 fig.pos="h" width="650"}

![Stakeholder gradings for group 2 in the Somerset Levels for the bigger principle of nature restoration](Plots/Somerset_G2_Bigger.png){#fig-SomBigG2 fig.pos="h" width="650"}

![Stakeholder gradings for group 3 in the Somerset Levels for the bigger principle of nature restoration](Plots/Somerset_G3_Bigger.png){#fig-SomBigG3 fig.pos="h" width="650"}
...
![Stakeholder gradings for group 1 in the Somerset Levels for the more principle of nature restoration](Plots/Somerset_G1_More.png){#fig-SomMoreG1 fig.pos="h" width="650"}

![Stakeholder gradings for group 2 in the Somerset Levels for the more principle of nature restoration](Plots/Somerset_G2_More.png){#fig-SomMoreG2 fig.pos="h" width="650"}

![Stakeholder gradings for group 3 in the Somerset Levels for the more principle of nature restoration](Plots/Somerset_G3_More.png){#fig-SomMoreG3 fig.pos="h" width="650"}

{{< pagebreak >}}

### Somerset Levels: Arable Reversion for Bigger

Stakeholder preferences for reversion of arable land to lowland wet grassland under the bigger principle of nature restoration for group 1 (@fig-SomArBigG1), group 2 (@fig-SomArBigG2) and group 3 (@fig-SomArBigG3).

![Stakeholder gradings for group 1 in Somerset for the reversion of arable land to lowland wet grassland under the bigger principle of nature restoration](Plots/Somerset_G1_ArableBig.png){#fig-SomArBigG1 fig.pos="h" width="650"}

![Stakeholder gradings for group 2 in Somerset for the reversion of arable land to lowland wet grassland under the bigger principle of nature restoration](Plots/Somerset_G2_ArableBig.png){#fig-SomArBigG2 fig.pos="h" width="650"}

![Stakeholder gradings for group 3 in Somerset for the the reversion of arable land to lowland wet grassland under bigger principle of nature restoration](Plots/Somerset_G3_ArableBig.png){#fig-SomArBigG3 fig.pos="h" width="650"}

{{< pagebreak >}}

### Somerset Levels: Arable Reversion for More

Stakeholder preferences for reversion of arable land to lowland wet grassland under the more principle of nature restoration for group 1 (@fig-SomArMoreG1), group 2 (@fig-SomArMoreG2) and group 3 (@fig-SomArMoreG3).

![Stakeholder gradings for group 1 in Somerset for the reversion of arable land to lowland wet grassland under the bigger principle of nature restoration](Plots/Somerset_G1_ArableMore.png){#fig-SomArMoreG1 fig.pos="h" width="650"}

![Stakeholder gradings for group 2 in Somerset for the reversion of arable land to lowland wet grassland under the bigger principle of nature restoration](Plots/Somerset_G2_ArableMore.png){#fig-SomArMoreG2 fig.pos="h" width="650"}

![Stakeholder gradings for group 3 in Somerset for the reversion of arable land to lowland wet grassland under the bigger principle of nature restoration](Plots/Somerset_G3_ArableMore.png){#fig-SomArMoreG3 fig.pos="h" width="650"}
